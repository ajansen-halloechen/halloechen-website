...
<template>
  <div class="flex flex-col gap-4 md:gap-6">
    ...
    <div
      class="mb-10 overflow-x-auto bg-surface rounded-md border border-primary"
    >
      <table class="min-w-full divide-y divide-primary">
          ...
          >
            ...
            >
              <div class="flex items-center gap-1">
                ...
                <slot
                  name="column-filter"
                  :column="header.column as Column<T, unknown>"
                />
              </div>
            </th>
          </tr>
        ...
        <tbody class="divide-y divide-gray-200">
          <tr v-if="table.getRowModel().rows.length === 0">
            ...
            >
              <slot name="empty"> Keine Einträge vorhanden. </slot>
            </td>
          </tr>
          <tr
