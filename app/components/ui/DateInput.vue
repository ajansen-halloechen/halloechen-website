    ...
    >
      ...
      >
        ...
        <DatePickerTrigger as-child>
          <button
            type="button"
            class="ml-auto cursor-pointer text-primary hover:text-primary-600"
              ...
              >
                ...
                >
                  <DatePickerCellTrigger
                    :day="day"
                    :month="month.value"
                    class="flex size-8 items-center justify-center rounded text-sm cursor-pointer hover:bg-primary/10 data-[selected]:bg-primary data-[selected]:text-on-primary data-[today]:font-bold data-[outside-view]:text-gray-300 data-[disabled]:text-gray-300 data-[disabled]:cursor-not-allowed data-[unavailable]:text-gray-300 data-[unavailable]:line-through"
                  />
                </DatePickerCell>
              </DatePickerGridRow>
            </DatePickerGridBody>
