...
const baseClass =
  'flex min-w-0 items-center w-full rounded-md border border-gray-300 bg-surface px-3 py-2 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary';
