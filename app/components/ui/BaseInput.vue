...
const containerClasses = computed(() => twMerge(baseClass, attrs.class as string));
const inputClasses = computed(() => twMerge(baseClass, 'outline-none', attrs.class as string));
